...
public class HomeActivity extends AppCompatActivity
    ...
    //vinculando el frament
        android.support.v4.app.FragmentManager fragmentManager=getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(R.id.contenido, new ReporteFragment() );
        fragmentManager.beginTransaction().replace(R.id.contenido, new QrFragment() );
